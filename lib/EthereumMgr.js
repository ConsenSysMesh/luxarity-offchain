...
class EthereumMgr {
  ...
  isSecretsSet() {
    return this.PG_HOST !== null || this.PG_DATABASE !== null || this.PG_USER !== null || this.PG_PASSWORD !== null || this.PG_PORT !== null || this.seed !== null;
  }
  ...
  async getNonce(address, networkName) {
    if (!address) throw "no address";
    if (!networkName) throw "no networkName";
    if (!this.PG_HOST) throw "no pgUrl set";
