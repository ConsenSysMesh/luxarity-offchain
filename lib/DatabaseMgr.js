...
//
 ...
 const client = new Client({
   ...
   const query = {
    ...
    values: [body.title, body.location, body.url, body.categories, body.startDate, body.endDate, body.problemSummary, body.problemEvidence, body.solution, body.stage, body.impact, body.funding, body.team, body.ready, body.workplan, body.risks, body.outcomes, body.outcome1, body.outcome2, body.outcome3, body.longTermImpact, body.benefits, body.learnings, body.budgetUrl, body.financialSustainability, body.imageUrl, body.sudmitterId, body.submissionDate, 'APPLIED']
    }
