...
class DatabaseMgr {
 ...
 const client = new Client({
  ...
  async promoteEventConfirm(body) {
   ...
   const query = {
    text: 'UPDATE projects_det SET record_status = \'confirmed\' WHERE project_Id = $1 RETURNING *',
  ...
  const query = {
    ...
    values: [body.project_id, body.userId, body.submissionDate, body.listingHash, body.challengerPublicKey, "watching_event"]
  }
  ...
  const query = {
    name: 'challenge',
    text: 'UPDATE PROJECTS_DET set status = $2, record_status = $3 where project_id = $1 RETURNING *',
    values: [body.project_id, 'CHALLENGED', 'watching_event']
  }
  ...
  const query = {
    ...
    text: 'UPDATE CHALLENGES set listinghash = $1, challengeid = $2, data = $3, commitEndDate = $4, revealEndDate = $5, challenger = $6, record_status = $7 where project_id = $8  RETURNING *',
    values: [body.listingHash, body.challengeId, body.data, body.commitEndDate,  body.revealEndDate,  body.challenger, 'confirmed', body.projectId]
  }
  ...
  const client = new Client({
   ...
   const query = {
    ...
    text: 'UPDATE VOTES SET record_status = \'confirmed\' WHERE pollId = $3 RETURNING *',
    values: [body.pollId]
  }
