...
class DatabaseMgr {
  ...
  const client = new Client({
    ...
    try {
      console.log("inside client.connect try");
        await client.connect();
        let SQL = 'SELECT * FROM projects_det_test WHERE record_status IS NULL OR record_status != \'not_confirmed\'';
  ...
  const query = {
    name: 'get-project',
    text: 'SELECT * FROM projects_det_test WHERE project_Id = $1 and (record_status IS NULL OR record_status != \'not_confirmed\')',
    values: [projectId]
  }
  ...
  const query = {
    name: 'get-project',
    text: 'SELECT * FROM projects_det_test WHERE submitter_id = $1 and (record_status IS NULL OR record_status != \'not_confirmed\')',
    values: [body.userId]
  }
...
//
 ...
 const client = new Client({
  ...
  async promoteProject(body) {
   ...
   const query = {
    text: 'UPDATE projects_det_test SET record_status = \'pending_event\', status = \'PROMOTED\', listinghash = $2, promoter_publickey = $3, promoter_userid = $4 WHERE project_Id = $1 RETURNING *',
  ...
  const client = new Client({
   ...
   const query = {
    ...
    text: 'UPDATE projects_det_test SET record_status = \'confirmed\' where listinghash = $1 RETURNING *',
  ...
  const client = new Client({
   ...
   const query = {
    name: 'promote-project',
    text: 'UPDATE projects_det_test SET record_status = \'\', status = \'APPLIED\', listinghash = \'\', promoter_publickey = \'\' WHERE project_Id = $1 RETURNING *',
    values: [body.projectId]
  }
  ...
  const query = {
    name: 'challenge',
    text: 'UPDATE projects_det_test set status = \'CHALLENGED\', record_status = \'pending_event\' where listinghash = $1 RETURNING *',
    values: [body.listingHash]
  }
  ...
  const query = {
    name: 'challenge',
    text: 'UPDATE projects_det_test set status = \'IN CHALLENGE PERIOD\', record_status = \'confirmed\' where project_Id = $1 RETURNING *',
    values: [body.projectId]
  }
  ...
  const query = {
    ...
    text: 'UPDATE  projects_det_test set record_status = $2, maxchallenge_id = $3 WHERE listinghash = $1 RETURNING *',
 ...
 // body.status='ACCEPTED',
  ...
  const query = {
    name: 'challengeEventConfirm',
    text: 'UPDATE  projects_det_test set status = $2, record_status = $3 WHERE listinghash = $1 RETURNING *',
 ...
 // body.status='ACCEPTED',
  ...
  const query = {
    name: 'challengeEventConfirm',
    text: 'UPDATE  projects_det_test set status = $2, rejection_date = $3, record_status = $4 WHERE listinghash = $1 RETURNING *',
  ...
  const query = {
    ...
    text: 'UPDATE projects_det_test SET userscommitedvotes = array_remove(userscommitedvotes, $1) RETURNING *',
    values: [body.userId]
  }
  ...
  const query = {
    ...
    text: 'UPDATE projects_det_test SET usersCommitedvotes = array_append(usersCommitedvotes, $1) where listinghash = $2 RETURNING *',
  ...
  const client = new Client({
   ...
   const query = {
    name: 'voteCommitEventConfirmed',
    text: 'UPDATE projects_det_test SET usersrevealedvotes = array_append(usersrevealedvotes, $1) RETURNING *',
    values: [body.userId]
  }
  ...
  const query = {
    ...
    text: 'UPDATE projects_det_test SET usersrevealedvotes = array_append(usersrevealedvotes, $1) where listinghash = $2 RETURNING *',
    values: [body.userId, body.listingHash]
  }
  ...
  const client = new Client({
   ...
   const query = {
    ...
    text: 'UPDATE projects_det_test SET usersrevealedvotes = array_remove(usersrevealedvotes, $1) RETURNING *',
    values: [body.userId]
  }
