...
class DatabaseMgr {
 ...
 const client = new Client({
  ...
  const query = {
    name: 'challenge',
    text: 'INSERT INTO CHALLENGES (project_id, status, record_status) VALUES($1,$2,$3) RETURNING *',
  ...
  const query = {
    ...
    text: 'INSERT INTO CHALLENGES (listinghash, challengeid, data, commitEndDate, revealEndDate, challenger, record_status) VALUES($1,$2,$3,$4, $5, $6, $7) RETURNING *',
