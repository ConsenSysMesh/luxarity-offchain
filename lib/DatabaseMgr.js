...
//
 ...
 const client = new Client({
  ...
  const query = {
    ...
    text: 'UPDATE CHALLENGES set  challengeid = $2, data = $3, commitEndDate = $4, revealEndDate = $5, challenger = $6, record_status = $7 where listinghash = $1 and record_status not in(\'confirmed\', \'Success\', \'Failed\') RETURNING *',
  ...
  const query = {
    ...
    text: 'UPDATE  PROJECTS_DET set record_status = $2 WHERE listinghash = $1 RETURNING *',
    values: [body.listingHash, 'confirmed']
  }
