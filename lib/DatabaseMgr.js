 ...
 const client = new Client({
  ...
  async promoteProject(body) {
   ...
   const query = {
    ...
    text: 'UPDATE projects_det SET record_status = \'not_confirmed\', status = \'PROMOTED\', promoter_publickey = $2 WHERE project_Id = $1 RETURNING *',
    values: [body.projectId, body.promoterPublicKey]
  }
  ...
  const query = {
    name: 'challenge',
    text: 'INSERT INTO CHALLENGES (project_id, user_id, submission_date, record_status) VALUES($1,$2,$3,$4) RETURNING *',
    values: [body.project_id, body.userId, body.submissionDate, 'not_confirmed']
  }
  ...
  async confirmChallenge(body) {
    ...
    console.log("inside confirmChallenge : "+body);
