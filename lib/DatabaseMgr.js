...
class DatabaseMgr {
  ...
  async insertOrder(body) {
    ...
    const query = {
    name: 'insertOrder',
    text: "INSERT INTO tst_orders(orderid,ordernumber,customeremail,totalcost,redemptionhash,customeremail256,tokenuri) \
             VALUES ($1,$2,$3,$4,$5,$6,$7) returning *",
    values: [body.orderId,body.orderNumber,body.customerEmail,body.totalprice,body.redemptionPinSHA256,body.customerEmailSHA256,body.tokenURI]
  }
    ...
    try {
      ...
      const res = await client.query(
        "INSERT INTO tst_causes(causeid,causename,orderid,donationamount) \
