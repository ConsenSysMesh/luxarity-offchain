...
class DatabaseMgr {
  ...
  const client = new Client({
   ...
   const query = {
    ...
    values: [body.title, body.location, body.descriptionShort, body.descriptionLong, body.submitterId, 'APPLIED', body.mediaTitle, body.images, body.category, body.problem, body.stage, body.impact, body.fundingGoal, body.teamInfo]
