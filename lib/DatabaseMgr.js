...
class DatabaseMgr {
 ...
 const client = new Client({
  ...
  const query = {
    name: 'challenge',
    text: 'INSERT INTO CHALLENGES (user_id, user_type, project_id, vote, submission_date, record_status) VALUES($1,$2,$3,$4,$5, $6) RETURNING *',
    values: [body.userId, body.userType, body.projectId, body.vote, body.submissionDate, 'not_confirmed']
  }
