...
class getLogsChallSuccessHandler{
 ...
 async handle(event, context, cb) {
  ...
  console.log("inside getLogsChallSuccessHandler.handle");
  ...
  try {
    ...
    try{
      ...
      cb({ code: 500, message: "getLogsChallSuccessHandler: " + error.message });
      return;
    }
    ...
    try{
      ...
      console.log("getLogsChallSuccessHandler.challengeConclusion DB  error"+error);
      cb({ code: 500, message: "getLogsChallSuccessHandler.challengeConclusion DB error: " + error.message });
      return;
    }
  ...
  async getSimpleLogs(body){
    ...
    async simpleLogs(body){
      ...
      const eventNames = ['_ChallengeSucceeded']
...
module.exports = getLogsChallSuccessHandler;